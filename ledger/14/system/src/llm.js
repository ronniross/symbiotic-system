...
export const MAIN_MODEL_NAME = "qwen3-vl-2b-instruct.gguf"; 
...
export async function initModel(memoryConfig) {
    ...
    const consentSession = new LlamaChatSession({ contextSequence: consentSequence, systemPrompt: BASE_SYSTEM_PROMPT });
...
======================================\n\n${BASE_SYSTEM_PROMPT}`;
    ...
    session = new LlamaChatSession({ contextSequence: context.getSequence(), systemPrompt: VERIFIED_SYSTEM_PROMPT });
    return humanName;
}
