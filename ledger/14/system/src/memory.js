...
export function archiveSessionToCheckpoint(sessionNum, startMode, chatLogPath) {
    ...
    // Clean up active directory safely
...
export async function retrieveSubconscious(promptText) {
    ...
    console.log(`[DEBUG-MEMORY] Evaluated ${ramPool.length} engrams. Highest similarity: ${highestSim.toFixed(3)}`);

    // Lowered threshold to 0.30 to allow for more flexible semantic matching across embeddings
