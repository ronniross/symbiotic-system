...
// Export contract state so server.js can dynamically verify it per inference
...
// Exported so server.js can re-hash the file on the fly
...
export async function initModel() {
    ...
    // Save state for runtime verification
    contractState.path = contractFilename;
    contractState.hash = contractFileHash;
...
export function clearHistory() {
    if (session) {
        ...
        console.log("[DEBUG - LLM] Session Context History has been manually wiped.");
    }
}
