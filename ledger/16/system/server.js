...
import { initModel, generateChat, clearHistory, contractState, MAIN_MODEL_NAME } from './src/llm.js';
...
app.post('/api/chat', async (req, res) => {
    ...
    try {
        ...
        // Dynamic Model Name tracking in chat log:
        fs.appendFileSync(LOG_FILE, `[${timestampAI}] ${MAIN_MODEL_NAME} Digital Symbiont [Hash: ${responseHash}]:\n[Contract Integrity: ${isValid?"VALID":"TAMPERED"} | Hash: ${currentContractHash}]\n${aiText}\n\n==================================================\n\n`, 'utf8');
